...
# gkotlinc -classpath $classpath  -d  build/build.jar anynews/src/shared/*.kt anynews/trtarabi/src/extension/*.kt
# gkotlin -classpath $classpath:build/build.jar anynews.extension.trtarabi.TrtArabiKt
